  ...
  const makePayment = async () => {
    ...
    try {
      if (paymentMethod === "cod") {
        // COD: Create order directly, mark as unpaid
        ...
        // Prepaid: Create Razorpay order with amount, only create DB order after payment succeeds
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <aside className="lg:col-span-1">
            ...
            >
              ...
              <div className="bg-gradient-to-r from-[#C4743F] to-[#007D71] px-5 md:px-8 py-4 md:py-6">
                            ...
                            {initialCoupons
                              ...
                              .map((coupon) => (
                                <button
                                  ...
                                  disabled={loading}
                                  className="group bg-[#F5F5F5] hover:bg-primary/5 border border-gray-200 hover:border-primary/30 py-2 px-3 rounded-xl transition-all text-left disabled:opacity-50"
                                >
